<x-layout>
    <x-slot name="header">
        <h1 class="font-bold text-2xl md:text-3xl lg:text-4xl text-left text-gray-800" data-aos="fade-up"
            data-aos-duration="500">
            {{ $data->judul }}
        </h1>
        <p class="text-xs md:text-sm lg:text-base mt-4" data-aos="fade-up" data-aos-duration="1000">Diposting pada
    ...
    <div class="container px-4 md:px-8 md:py-8 mx-auto">
        <article>
            <div class="px-2 mb-20" data-aos="zoom-in-down" data-aos-duration="1500">
        ...
        <div class="flex items-center w-full gap-x-3 shrink-0 sm:w-auto justify-end mt-8">
            <a href="{{ url()->previous() }}"
                class="flex items-center justify-center w-1/2 px-5 py-2 text-base text-white transition-colors duration-200 bg-teal-600 border rounded-lg  gap-x-2 sm:w-auto hover:bg-teal-500">
