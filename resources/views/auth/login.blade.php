<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center mt-6 -mx-2">
            <x-primary-button class="ms-3 flex items-center justify-center w-full px-6 py-2 mx-2 font-medium">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
        ...
        {{-- <div class="flex items-center -mx-2">
            <a href="/login/google/authenticate"
                ...
                <span class="mx-2 sm:inline">Masuk dengan Google</span>
            </a>
        </div> --}}
    </form>
